          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-8">
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <img src="https://masai-website-images.s3.ap-south-1.amazonaws.com/Frame_6_2_21456d0338.svg" alt="Misogi AI Logo" className="h-6 sm:h-8 w-auto" />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 lg:ml-8">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 animate-pulse">
                <div className="flex items-start gap-4 mb-6">
                  <div className="h-12 w-12 sm:h-16 sm:w-16 bg-gray-200 rounded-full"></div>
                  <div className="flex-1">
              ...
              {filteredStudents.length > 0 ? (
                ...
                <div className="col-span-full text-center py-8 sm:py-12">
                  <div className="text-gray-400 mb-4">
                    <Search className="h-8 w-8 sm:h-12 sm:w-12 mx-auto mb-4" />
                  </div>
